-- Legacy reference snapshot. After Flyway adoption, do not execute this file manually.
-- New DB: dbMigrate. Existing DB: dbCheck -> dbBaseline -> dbMigrate.
-- Future changes belong in src/main/resources/db/migration/V2__description.sql, V3__, ...
CREATE DATABASE IF NOT EXISTS sgcomplaint
